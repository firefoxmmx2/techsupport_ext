...
Ext.onReady(function() {
	var cm = new Ext.grid.ColumnModel({
		columns:[{header:'序号',tooltip:'提示序号',align:'right',width:40,dataIndex:'ID'},{header:'产品名称',tooltip:'XX产品名称',align:'left',width:100,dataIndex:'Name'}],//注意此dataIndex要与product中的name对应，且却分大小写
	...
	var panel  = Ext.create({renderTo:'dict_manage_panel',//html页面上面必须要有以此div_grid为id的标签
		xtype:"panel",title:"panel",layout:"vbox",items:[{
			xtype:'grid',
			title:'字典管理',id:'xxxx',
			tbar:'头部',
			border:false,
